...
- **Nager MCP UI Website**: [https://date.nager.at](https://date.nager.at)
- **API Documentation**: []()
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/nager-mcp-ui-mcp-server.git
   cd nager-mcp-ui-mcp-server
   ```
...
1. Create API client functions for Nager MCP UI endpoints
